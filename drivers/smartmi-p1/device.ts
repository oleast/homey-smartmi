...
class SmartmiP1Device extends Homey.Device {
   ...
   */
  async onCapabilitySound(value: boolean): Promise<boolean> {
   ...
   */
  async onCapabilityScreenBrightness(value: string): Promise<boolean> {
   ...
   */
  async onCapabilityTimer(value: string): Promise<boolean> {
